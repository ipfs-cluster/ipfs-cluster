...
require (
	...
	github.com/ipfs/go-ds-crdt v0.4.1-0.20230613211822-7e25623a83c4
...
replace github.com/hsanjuan/ipfs-lite => github.com/aschmahmann/ipfs-lite v0.0.0-20230613211134-1e8fb0dec972
