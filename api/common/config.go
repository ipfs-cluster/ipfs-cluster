...
// Config is used to intialize a common API object and allows to customize its
// behaviour of it. It implements most of the config.ComponentConfig interface
// (except the Default() and ConfigKey() methods). Config should be included
// in a standard config.
type Config struct {
	config.Saver
